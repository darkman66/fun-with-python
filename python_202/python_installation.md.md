...
active virtualenv with pyenv

```bash
pyenv install 3.7.4
pyenv virtualenv 3.7.4 your_venv_name
...
# To update, run:
#
#    pip-compile --output-file=requirements.txt req.in
#
asgiref==3.5.2
    # via django
django==4.1.3
...
Using base prefix 'c:\\users\\hub\\appdata\\local\\programs\\python\\python37'
New python executable in C:\Users\hub\Desktop\cmder\stuff1\Scripts\python.exe
...
```PowerShell
λ C:\Users\hub\Desktop\cmder\stuff1\Scripts\activate.bat

C:\Users\hub\Desktop\cmder
(stuff1) λda
```
